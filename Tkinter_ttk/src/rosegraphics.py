...
#                      ('make_initial_canvas', make_initial_canvas, bool)])
    ...
    def get_next_mouse_click(self):
        # update graphics and flush any prior clicks
        self.render()
        self.mouse.reset()
        ...
        while True:
            ...
            if self.mouse.mouse_was_pressed:
                return self.mouse.mouse_position
...
class Keyboard(object):
    ...
    def _update(self, event):
        ...
        """
        self.key_that_was_pressed = event.keysym
...
class _ShapeWithThickness(object):
    ...
    def initialize_options(self, color=None, thickness=None):
        if color is None:
...
class Line(_Shape, _ShapeWithThickness):
    ...
    def __init__(self, start, end, color=None, thickness=None):
        ...
        super().initialize_options(color, thickness)
