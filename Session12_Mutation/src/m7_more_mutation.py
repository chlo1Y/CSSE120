...
def RETURN_delete_negatives(numbers):
    ...
    list1 = []
    for k in range(len(number2)):
        if type(number2[k]) == float:
            list1 = list1 + [number2[k]]
        elif type(number2[k]) == int:
            list1 = list1 + [number2[k]]
    return list1
...
#         if type(numbers[k]) == int:
#             list1 = [] + [numbers[k]]
#         elif type(numbers[k]) == float:
#             list1 = [] + [numbers[k]]
#     return list1
    ...
    list1 = []
    for k in range(len(numbers)):
        if type(numbers[k]) == float:
            list1 = list1 + [numbers[k]]
        elif type(numbers[k]) == int:
            list1 = list1 + [numbers[k]]
    return list1
